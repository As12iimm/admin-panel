...
const ROLE_PERMISSIONS = {
  ...
  medical: [ACTIONS.VIEW_DASHBOARD, ACTIONS.MANAGE_MEDICAL, ACTIONS.MANAGE_COMPLIANCE, ACTIONS.MANAGE_NOTIFICATIONS, ACTIONS.VIEW_ANALYTICS],
  agent: [ACTIONS.VIEW_DASHBOARD, ACTIONS.MANAGE_LEADS, ACTIONS.MANAGE_LEAD_TASKS, ACTIONS.VIEW_ANALYTICS]
};
